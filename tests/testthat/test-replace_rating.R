...
test_that("replace_rating replaces ratings",{
    ...
    x <- c("This place receives 5 stars for their APPETIZERS!!!",
         paste(
             "Four stars for the food & the guy in the blue", 
             "shirt for his great vibe!"
         ),
         "10 out of 10 for both the movie and trilogy.",
         paste(
             "* Both the Hot & Sour & the Egg Flower", 
             "Soups were absolutely 5 Stars!"
        ),
    ...
    x2 <- c("This place receives best for their APPETIZERS!!!", 
        " better for the food & the guy in the blue shirt for his great vibe!", 
        " best for both the movie and trilogy.", 
        "* Both the Hot & Sour & the Egg Flower Soups were absolutely best !", 
        "For service, I give them terrible .", "This place deserves terrible .", 
        " best stars.", "My rating: just below average .", 
        "If there were terrible I would give it terrible .", 
        "Rating: extremely below average .", 
        "I gave it best because of the sound quality.", 
