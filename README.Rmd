...
| `filter_row`              | filter rows | Remove rows matching a reqex          |
...
| `check_spelling`          | check       | Check text spelling                   | 
